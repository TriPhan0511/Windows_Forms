...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        // This integer variable keeps track of the remianing time.
        int timeLeft;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                // If CheckTheAnswer() returns true, the user got the answer right.
            ...
            {
                // If CheckTheAnswer() returns false, keep couting down.
                // Decrease the time left by one second and
                // display the new time left by updating the timeLabel
                timeLeft--;
                timeLabel.Text = timeLeft + " seconds";
            }
            else
            {
                ...
                // show a MessageBox, and fill the answers.
                timer1.Stop();
